namespace EpsilonEngine
{
    ...
    {
        #region Config
        public const bool ConstFramerate = false;
        public const int TargetFramerate = 120;
        public const string WindowTitle = "Epsilon - InfDev 1";
        public const int RenderWidth = 512;
        public const int RenderHeight = 288;
        public const bool LaunchFullscreen = true;
        public const bool HideCursor = true;
        #endregion
        ...
        public XNAInterface(UpdateCallback updateCallback)
        {
            ...
            XNAGame.TargetElapsedTime = new System.TimeSpan(10000000 / TargetFramerate);
            XNAGame.MaxElapsedTime = new System.TimeSpan(10000000 / TargetFramerate);
            XNAGame.IsFixedTimeStep = ConstFramerate;
            XNAGame.IsMouseVisible = !LaunchFullscreen || !HideCursor; // Show the cursor unless we are fullscreen and hiding it is requested.
            ...
            XNAGraphicsDeviceManager.IsFullScreen = LaunchFullscreen;
